    ...
    public class GoogleDriveFilesRepository 
    {
        ...
        public static void FileUpload(HttpPostedFileBase file)
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["wtmk"].ConnectionString);
                string insert = "insert into Music (IDdrive,Musicname)" +"Values (N'" + newfile.Id + "',N'" + "baihat" + "')";
                con.Open();
        ...
        public static void DeleteFile(GoogleDriveFiles files)
        {
            ...
            try
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["wtmk"].ConnectionString);
                string del = "delete from Music where IDdrive = files.Id";
                con.Open();
